...
# v31   ->  le estoy metiendo las funciones para guardar los datos de los territorios
#           -> create_heatmap daba errores y lo he quitado, ya lo reimplementaré a futuro
...
def initialization(area, population,EV_percentage, directory, type_services):
    ...
    try:
        df_buildings = pd.read_csv(data_path / f'df_buildings.csv')
        ...
        df_buildings.to_csv(data_path / f'df_buildings.csv', index=False)
...
def archetype_probability_movement(archetype, hour):
    ...
    behavior_model = main_path / f'Data/Behaviour Models'
...
if __name__ == "__main__":
    ...
    # Inicialización
    df_buildings, df_actions, df_citizens, df_vehicles, df_moving_agents = initialization(area, population_citizens, EV_percentage, data_path, type_services)
