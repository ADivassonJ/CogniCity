...
def initialization(ciudad, population, directory, type_services):
    ...
    df_services_buildings = pd.DataFrame(services_buildings)
...
def next_move(df_services, data, buildings_df, intention):
    ...
    while new_building == building_name or actual_intention == False:
        new_building = random.choice(buildings_df['osmid'])
        actual_intention = df_services[intention] == new_building
